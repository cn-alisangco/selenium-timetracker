...
public class TC019_TimeTracker_ChargeHours_DailyWorkHours_ActualWorkHoursTypeOfWork extends BaseClass {
	...
	@Test
	 public void loginToTimeTracker() throws Exception{
	    	...
	    	String id = "TC019_TimeTracker_ChargeHours_DailyWorkHours_ActualWorkHoursTypeOfWork";
	    	...
	    	dailyWorkHours.chooseTypeOfWork(typeOfWork);
	}
}

...
public class TestWorkHours_TC19_to_TC23_Daily_Work_Hours_Save_and_Verify_Details extends BaseClass {
	...
	public static String tcName = "TC19-TC23_TimeTracker_DWH"; // test case name
	...
	public void Enter_Work_Hours() {
		...
		dailyWorkHoursPage.enterWorkHours(sheetName, tcName, "WorkHours");
		dailyWorkHoursPage.selectWorkType(sheetName, tcName, "WorkType");
		dailyWorkHoursPage.enterTaskDescription(sheetName, tcName, "TaskDesc");

...
public class TestTimeLogs_TC7_Enter_Time_Logs_and_Cancel extends BaseClass {
	...
	public static String tcName = "TC7_TimeTracker"; // test case name

	// TestNG Annotation
	// This is the Actual Test

	@Test(priority = 1)
	public void Enter_Time_Logs_and_Cancel() {
		...
		if (homePage.checkIfDateExists(date).equalsIgnoreCase("Yes")) {
			...
			if (dateExists.equalsIgnoreCase("Yes")) {
				...
				homePage.verifyDetailsAreLeftBlanked();
			}

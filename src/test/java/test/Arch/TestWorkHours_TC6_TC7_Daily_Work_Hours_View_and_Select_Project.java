...
public class TestWorkHours_TC6_TC7_Daily_Work_Hours_View_and_Select_Project extends BaseClass {
	...
	public static String tcName = "TC6_TC7_TimeTracker_DWH"; // test case name
	...
	public void Enter_Work_Hours() {
		...
		dailyWorkHoursPage.printProjects();

...
public class TestTimeLogs_TC2_Enter_Time_Logs_TimeOut_Only extends BaseClass {
	...
	public static String tcName = "TC2_TimeTracker"; // test case name

	// TestNG Annotation
	// This is the Actual Test

	@Test(priority = 1)
	public void Enter_Time_Logs_TimeOutOnly() {

...
public class TestWorkHours_TC18_Daily_Work_Hours_Check_Allocated_Hours extends BaseClass {
	...
	public static String tcName = "TC18_TimeTracker_DWH"; // test case name
	...
	public void Enter_Work_Hours() {
		...
		dailyWorkHoursPage.checkAllocatedHours();

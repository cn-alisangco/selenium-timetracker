...
//		expectedUsername = LoginPage.getUserName();
	...
	public void selectTimeSheetPeriod(String sheetName, String tcName, String columnName) {
		waitForElement(timeSheetPeriodDropDown);
		timeSheetPeriodDropDown.click();;
